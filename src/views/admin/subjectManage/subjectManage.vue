<template>
    <div>
        ...
        <div class="down">
            <div>
                <ListView :data="data" :column="column" title="课题列表">
                    <slot>
    ...
    methods: {
        ...
        buildColumn() {
            return [
                ...
                { prop: "attachment", label: "材料", width: 300 },
                { prop: "fee", label: "费用", width: 100 },
                { prop: "finished", label: "是否结项", width: 100 },
                { prop: "origin", label: "课题来源", width: 230 },
                { prop: "participant", label: "参与者", width: 100 },
                { prop: "period", label: "课题周期", width: 230 },
                { prop: "rank", label: "等级", width: 70 },
                { prop: "subjectNo", label: "编号", width: 80 },
                { prop: "type", label: "类型", width: 100 },
                { prop: "userId", label: "负责人id", width: 80 },
            ];
        }
    },
